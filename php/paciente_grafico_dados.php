...
// 3. Monta a condição da query SQL baseada no período
$sql_where_condition = '';
switch ($range) {
    case 'diario':
...
// 4. Busca os registros no banco de dados
$stmt = $conn->prepare(
