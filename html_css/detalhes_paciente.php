...
<body>
                ...
                <table>
                    ...
                    <tbody>
                        <?php if (count($registros) > 0): ?>
                            <?php foreach (array_reverse($registros) as $reg): // Inverte para mostrar o mais recente primeiro na tabela ?>
                                <tr>
                                    <td><?php echo date('d/m/Y H:i', strtotime($reg['data_hora'])); ?></td>
                                    <td><?php echo $reg['sistolica']; ?></td>
                                    <td><?php echo $reg['diastolica']; ?></td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
                            <tr>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Carrega o gráfico inicial com a visão "semanal"
